	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<div class="dropdown">
					...
					<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Groups.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Groups.id'))); ?></li>
