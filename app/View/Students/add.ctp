<?php
  ...
  $this->Html->script('View/Details/add', array('inline' => false));
?>
		...
		<div class="actions">
			...
			<div class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="list-group-item"><?php echo $this->Html->link(__('New Groups'), array('controller' => 'groups', 'action' => 'add')); ?> </li>
					</ul>
			</div>
			<div class="dropdown">
