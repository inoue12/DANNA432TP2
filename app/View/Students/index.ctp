		...
		<div class="actions">
			...
			<div class="dropdown">
				...
				<ul class="dropdown-menu">	
					<li class="list-group-item"><?php echo $this->Html->link(__('New Students'), array('controller' => 'students', 'action' => 'add')); ?> </li>
				</ul>
			</div>
			<div class="dropdown">
...
<?php foreach ($students as $student): ?>
	<tr>
		...
		<td><?php echo h($student['Student']['other_details']); ?>&nbsp;</td>
		<td><?php 
            foreach ($student['Group'] as $tag) { 
                // echo h($tag['id']) . ' '; 
