...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<div class="dropdown">
				...
				<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Teacher.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Teacher.id'))); ?></li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<h2><?php echo __('Edit Teacher'); ?></h2>
